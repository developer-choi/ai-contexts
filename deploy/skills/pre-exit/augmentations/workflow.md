...
(a)가 '안 읽은 링크 문서'를 잡는다면, 본 절차는 **진입한 step.md 본문에 인라인으로 박힌 [CRITICAL]·필수 절차의 *실행 여부***까지 본다. 특히 "판정·결론을 내리기 전에 읽어야 하는 단일 출처 문서"를 안 읽고 판정한 경우를 잡는다.
...
**(a)·(e)는 토큰 비용을 이유로 생략하지 않는다** — 미실행 절차·미독 단일출처 누락을 잡는 핵심 절차다(가벼운 버전으로 대체 금지).
