...
- **반객관** — 금지어 · em/en dash(10a) · 의문형 물음표 · 내부 작업이력(5a) · 습니다체 휴리스틱(1a) · 빈 섹션 · placeholder 잔존 · 핵심명제 누락. 위반 개수와 해당 줄을 출력한다. 눈으로 확인해야 하는 항목(문맥 확인 필요, 습니다체 휴리스틱, 개수 선언 뒤 리스트 없음, `placeholder_policy: keep`의 placeholder)은 기계 적발 합계에서 빠진다.
