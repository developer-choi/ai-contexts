...
PR_{N}_PLAN.step-4 그 자리 실행·커밋 완결(가벼운 PR) ──→ IMPL 세션 없이 PR_{N}_WRITING; PR_{N+1}_PLAN 선행 = 본 step-4 완료
