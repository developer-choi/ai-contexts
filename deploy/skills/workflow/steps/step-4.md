...
[conventions/artifact/implementation-spec.md](../conventions/artifact/implementation-spec.md) 「`it.todo` 매칭 게이트 > PLAN 종료 시점」 적용. 게이트 결과(매칭/누락/면제 분류)는 「보고 내용」에 포함한다.
