...
- 모든 슬라이스 사이클 종료 후 「Step 5.4. 커밋 정리·재정렬」에서 백업 브랜치 → squash/분할 → 사용자 force-push 요청 순으로 일괄 정리한다
...
모든 슬라이스의 리뷰 파이프라인이 0건 통과하면 step-5 종료 직전에 다음 순서로 수행한다. 이 섹션은 Step 5.3의 각 슬라이스 사이클이 모두 끝난 뒤 한 번만 실행한다.

### Step 5.4.1. 백업 브랜치 [CRITICAL]
...
#### Step 5.4.2-A. stub이 빈 껍데기인 정상 케이스
...
#### Step 5.4.2-B. stub이 본문을 안고 있는 케이스
...
### Step 5.4.3. 사용자에게 force-push 요청 안내
