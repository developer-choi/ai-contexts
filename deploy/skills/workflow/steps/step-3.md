...
상단에 큐 모델 자가 정리 안내문을 박는다 ([conventions/plan-folder.md](../conventions/plan-folder.md) 「consumable/ 산출물 자가 정리 안내문」). 본 파일 모든 절의 마지막 소비자는 step-7 (PR 본문 작성) — step-7에서 PR 본문으로 소비 (consumable 큐 모델).
...
- step-7에서 PR 본문 "Known issues / Follow-up" 절로 소비 (overview.md는 consumable 큐 모델)
