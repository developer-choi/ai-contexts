...
7. 초안과 발견한 문제를 사용자에게 제시합니다. **여기서 멈춥니다. 파일에 저장하지 않습니다. 사용자 응답을 기다립니다.**

#### 논의

SKILL.md 3단계를 따릅니다. `/discussion`으로 미결 항목의 결론을 냅니다. 확정된 내용은 산출물에 기록하고, 사용자가 판단할 수 없는 항목은 TODO로 분류합니다.
