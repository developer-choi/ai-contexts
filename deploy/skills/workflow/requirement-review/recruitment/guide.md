...
- `/plan/background/consumable/todo.md` — 세부 스펙·교차 분석 발견·기술 결정 후보·모호한 부분·TODO (없으면 이 시점에 생성)
...
- 나중에 옮길 셈으로 cross-analysis.md에 임시로 담아두지 않는다 — 사용자가 todo.md를 직접 리뷰하므로, 옮길 내용은 처음부터 todo.md에 쓴다.
- todo.md에 직접 기록하는 것은 항목 리스트까지다. 산문 서술은 SKILL.md 「todo.md 산문·초기 셋업 CLI는 사용자가」를 따른다.
