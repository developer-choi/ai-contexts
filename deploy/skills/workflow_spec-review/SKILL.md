...
기획 체크리스트는 **항상** 적용합니다. 디자인 체크리스트는 디자인 시안이 함께 있을 때 **추가로** 적용합니다.

| 상황 | 적용 체크리스트 |
|------|---------------|
| 기획서만 있음 | [checklist/](./checklist/) |
| 기획서 + 디자인 시안 | [checklist/](./checklist/) + [checklist/design/](./checklist/design/) |
...
사용자에게 스크린샷을 넣을 폴더 경로를 요청합니다. 이후 사용자가 "넣었어" 등으로 알려주면 해당 폴더의 이미지를 **모두** 읽고, 읽은 뒤 이미지를 삭제합니다.
...
사용자에게 `page-N.md`를 확인하라고 안내합니다. 수정할 부분이 있으면 반영하고, 없으면 2-0으로 돌아가 다음 페이지를 준비합니다.
