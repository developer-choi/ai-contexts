...
#### 작성 방법
1. **난제 정의**: 기술적으로 고민이 필요한 과제를 정의
2. **선택지 탐색**: 최소 2가지 대안 검토
3. **장단점 비교**: 성능, 개발 비용, 유지보수성, 리스크 등 비교
4. **결정 근거**: 프로젝트 맥락(데이터 특성, 트래픽, 팀 역량) 반영
5. **트레이드오프 명시**: 선택한 방안의 단점과 왜 그럼에도 최선인지 설명
