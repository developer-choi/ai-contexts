...
> **[roadmap](instructions/self-help/roadmap.md) 연결**: 2단계 - 선택지 탐색, 3단계 - 결정의 근거
>
...
## [CRITICAL] Project 문서 최신화 (간소화)

`/plan/project.md` 파일이 존재하는 경우, 문서의 가독성을 높이기 위해 **현재 진행하려는 PR의 상세 내용(본문)을 삭제하고 제목만 남기세요.**

- **목적**: `project.md`는 전체 로드맵을 보여주는 역할이며, 구체적인 내용은 이제 `overview.md`에서 다루기 때문입니다.
- **방법**: 해당 PR 항목의 하위 내용(범위, 기획 확인 필요 등)은 모두 지우세요.
