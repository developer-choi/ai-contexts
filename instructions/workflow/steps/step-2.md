...
**⚠️ PR 분할 전략 수립(project.md 또는 codebase-audit.md 작성)을 완료한 후, 다음 단계(핵심 과제 정의)로 넘어가기 전에 사용자 확인이 필요합니다.**

### AI의 필수 질문 (다음 단계 진행 전)

작성을 완료한 후, 사용자에게 다음과 같이 물어보세요:

> "PR 분할 전략 수립이 완료되었습니다.
>
> 다음 단계(핵심 과제 정의)로 넘어가기 전에 확인이 필요합니다.
>
> **이번 단계에서 작성한 문서들을 읽고 이해하셨나요?**
> - `/plan/codebase-audit.md` (작성한 경우만)
> - `/plan/project.md` (작성한 경우만)
>
> - PR 분할 전략이 명확한가요?
> - 각 PR의 범위와 의존성이 이해되시나요?
> - 이해가 안 되거나 불필요한 내용이 있으신가요?
>
> ⚠️ **작성한 문서를 충분히 이해하지 못한 상태에서 다음 단계로 넘어가면, 잘못된 기술 전략 수립으로 이어집니다.**
>
