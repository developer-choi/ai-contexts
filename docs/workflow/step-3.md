...
> **❌ Bad**: "React Query를 쓰면 되겠네요."
>
> **✅ Good**: "React Query vs SWR vs 직접 구현을 비교했고, 현재 프로젝트는 복잡한 캐싱과 낙관적 업데이트가 필요하므로 React Query를 선택합니다. 번들 사이즈가 약간 크지만, 팀원 모두 경험이 있어 학습 비용이 없고 트러블슈팅이 용이합니다."
