...
## [CRITICAL] Step 2를 먼저 진행했나요?

[Step 2의 체크리스트](./step-2.md)를 확인하여, 

PR을 분할해야할만큼 작업이 크면 Step 2를 먼저 진행해주세요.
...
1. **PR 단위**: 하나의 `/plan/overview.md`는 하나의 PR에 해당합니다.
...
**범위 제한**: 하나의 `/plan/overview.md`는 하나의 PR, 하나의 세부 기능에 집중해야 합니다.
...
### 2. 핵심 기술적 과제 (Technical Challenges)

구현 시 기술적으로 고민이 필요한 부분을 나열하세요.
...
`/plan/overview.md` 작성이 완료되면, 반드시 다음을 수행하세요.
