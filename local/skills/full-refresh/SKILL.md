...
**dispatch 발행** — 후보 목록과 갱신 규칙을 dispatch MD(`backlog/full-refresh/dispatch/<repo>-readme.md`)에 박아 [위임 플로우](#위임-플로우)로 새 세션에 넘긴다. dispatch MD에 박을 내용:
...
- 결과 md 경로: `backlog/full-refresh/dispatch/<repo>-readme-result.md`
