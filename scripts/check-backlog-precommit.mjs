...
// cherry-pick·merge·amend는 pre-commit이 안 도므로 reference-transaction(check-backlog-ref.mjs)이
// 백스톱으로 같은 정책을 강제한다. 판정 로직은 backlog-path-policy.mjs 한 곳을 공유한다.
import { execFileSync } from "node:child_process";
import { parseNameStatusZ, findViolations, formatViolations, rebaseInProgress } from "./backlog-path-policy.mjs";
